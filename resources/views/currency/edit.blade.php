            ...
            <div class="card-body">
                <div class="row">
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="currency_form" method="POST" action="{{ route('currency.update',$currency) }}">
                                @method('PUT')
                                @csrf
                                <div class="form-group row">
                                    <label for="currency">{{ __('Brand') }}</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row ">
                                    <div class="col-md-4 col-md-offset-4">
                                        <button type="submit" class="btn btn-primary btn-block" onclick="event.preventDefault(); document.getElementById('currency_form').submit();">
                                            {{ __('Save') }}
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="tags_form" method="POST" action="{{ route('currency.store_tags',$currency) }}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6">
...
@push('js')
    <script>
        ...
        function getTags(headers){
            ...
            var tags = {!! json_encode($currency->tags) !!};
            $.ajax({
