            ...
            <div class="card-body">
                <div class="row">
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="company_form" method="POST" action="{{ route('company.update',$company) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-group row ">
                                    <div class="col-md-4 col-md-offset-4">
                                        <button type="submit" class="btn btn-primary btn-block" onclick="event.preventDefault(); document.getElementById('company_form').submit();">
                                            {{ __('Save') }}
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="tags_form" method="POST" action="{{ route('company.store_tags',$company) }}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6">
...
@push('js')
    <script>
        ...
        function getTags(headers){
            ...
            var tags = {!! json_encode($company->tags) !!};
            $.ajax({
