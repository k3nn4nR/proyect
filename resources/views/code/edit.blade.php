            ...
            <div class="card-body">
                <div class="row">
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="code_form" method="POST" action="{{ route('code.update',$code) }}">
                                @method('PUT')
                                @csrf
                                <div class="form-group row">
                                    <label for="code">{{ __('Code') }}</label>
                                    <div class="col-md-6">
                                        <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" required placeholder="{{ $code->code }}">
                                        @error('code')
                                ...
                                <div class="form-group row ">
                                    <div class="col-md-4 col-md-offset-4">
                                        <button type="submit" class="btn btn-primary btn-block" onclick="event.preventDefault(); document.getElementById('code_form').submit();">
                                            {{ __('Save') }}
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="tags_form" method="POST" action="{{ route('code.store_tags',$code) }}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6">
...
@push('js')
    <script>
        ...
        function getTags(headers){
            ...
            var tags = {!! json_encode($code->tags) !!};
            $.ajax({
