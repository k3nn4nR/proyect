...
@section('content_header')
    <h1 class="m-0 text-dark">Warehouse Create</h1>
@stop
...
<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form id="form" method="POST" action="{{ route('warehouse.store') }}">
                        @csrf
                        <div class="form-group row">
                            <label for="warehouse">{{ __('Warehouse') }}</label>

                            <div class="col-md-6">
                                <input id="warehouse" type="text" class="form-control @error('warehouse') is-invalid @enderror" name="warehouse" required autofocus>
