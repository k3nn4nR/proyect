            ...
            <div class="card-body">
                <div class="row">
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="type_form" method="POST" action="{{ route('type.update',$type) }}">
                                @method('PUT')
                                @csrf
                                <div class="form-group row">
                                    <label for="type">{{ __('Type') }}</label>
                                    <div class="col-md-6">
                                        <input id="type" type="text" class="form-control @error('type') is-invalid @enderror" name="type" required placeholder="{{ $type->type }}">
                                        @error('type')
                    ...
                    <div class="card col-6">
                        <div class="card-body">
                            <form id="tags_form" method="POST" action="{{ route('type.store_tags',$type) }}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6">
...
@push('js')
    <script>
        ...
        function getTags(headers){
            ...
            var tags = {!! json_encode($type->tags) !!};
            $.ajax({
